import { z } from 'zod';
import { A as AstroError, a as ActionNotFoundError, b as ActionCalledFromServerError } from './astro/server_BBJbpwIx.mjs';
import { A as ActionError, s as serializeActionResult, d as deserializeActionResult, a as ACTION_RPC_ROUTE_PATTERN, b as ACTION_QUERY_PARAMS, c as callSafely, e as ActionInputError } from './shared_CPAhQ-9r.mjs';
...
async function getAction(path) {
  ...
  let { server: actionLookup } = await import('./_astro_internal-actions_C-CoQurj.mjs');
